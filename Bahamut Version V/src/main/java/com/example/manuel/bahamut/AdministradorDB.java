...
public class AdministradorDB {
    ...
    public static final String CREATE_TABLE_HORARIO = "create table clase (id_clase integer primary key autoincrement, tipo text, CfechaDesde text, CfechaHasta text, "+
    ...
    public static final String CREATE_TABLE_NOTAS = "create table notas (id_notas integer primary key autoincrement, nombre text, porcentaje integer, valor integer, fecha integer"+
                                                                         ", asignaturaFKNotas integer not null, foreign key(asignaturaFKNotas) references asignatura(id) ON DELETE CASCADE);";
    ...
    private ContentValues generarContentValuesClases(String tipo, String sala,String fechaDesde, String fechaHasta, String horaDesde, String horaHasta, String semana, int idAsignatura){
        ContentValues valores= new ContentValues();
        valores.put("CfechaDesde",fechaDesde);
        valores.put("CfechaHasta",fechaHasta);
        valores.put("CtiempoDesde",horaDesde);
        valores.put("CtiempoHasta",horaHasta);
        valores.put("tipo",tipo);
        valores.put("sala",sala);
        valores.put("semana",semana);
        valores.put("asignaturaFK",idAsignatura);
    ...
    public void insertarClase(String tipo, String sala, String fechaDesde, String fechaHasta, String horaDesde, String horaHasta, String semana, int idAsignatura){
        db.insert("clase",null,generarContentValuesClases(tipo,sala,fechaDesde,fechaHasta,horaDesde,horaHasta,semana,idAsignatura));
    }
    ...
    */
    ...
    public Cursor cargarClase(){
        return db.rawQuery("select * from clase",null);
    }
    ...
    public Cursor contarAsignaturas(int id_semestre){
        return db.rawQuery("select count(*) from gestion_sa where id_gestionSemestre="+id_semestre,null);
    }

    public Cursor mostrarAsignaturas(int id_semestre){
        return db.rawQuery("select x.id, x.nombre, x.color, x.icono from asignatura x, gestion_sa y\n" +
                "where y.id_gestionSemestre="+id_semestre+" and x.id=y.id_gestionAsignatura",null);
    }

    public Cursor mostrarClases(int id_asignatura){
        return db.rawQuery("select * from clase where asignaturaFK="+id_asignatura,null);
    }

    public Cursor mostrarClaseDelDia(){
        return db.rawQuery("select x.tipo,x.CfechaDesde,x.CfechaHasta,x.CtiempoDesde,x.CtiempoHasta,x.sala,x.semana,y.nombre,y.color," +
                "y.icono,x.asignaturaFK from clase x, asignatura y where x.asignaturaFK=y.id ",null);
    }
    ...
    public Cursor cargarGestion(){
        return db.rawQuery("select * from gestion_sa",null);
    }
    ...
    public void eliminarTodoClase(){
        db.rawQuery("delete from clase",null);
    }
    ...
    public void eliminarClase(int id_Clase){
        db.delete("clase", "id_clase="+id_Clase,null);
    }
