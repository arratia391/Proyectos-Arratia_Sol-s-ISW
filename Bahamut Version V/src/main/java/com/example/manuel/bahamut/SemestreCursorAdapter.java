...
public class SemestreCursorAdapter extends BaseAdapter {
    ...
    public void actualizar(int position, String nombre, String fecha_desde, String fecha_hasta,int cantidadAsignaturas){
        SemestreItem sem = new SemestreItem(nombre,fecha_desde,fecha_hasta,cantidadAsignaturas);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView contador = (TextView) convertView.findViewById(R.id.tvCantidadSemestre);

        texto.setText(arraySemestre.get(position).getNombre());
        String prueba = String.valueOf(arraySemestre.get(position).getCantidadAsignaturas());
        contador.setText(prueba);
